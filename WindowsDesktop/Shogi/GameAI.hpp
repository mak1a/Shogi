...
public:
    BanSelf(const array<array<uint32, 9>, 9>& iniKyokumen_, const array<uint32, 40>& motigomas_, const Turn& turn_, const uint32 sikouDepth_, const double shogiBan_ = 540.f, const double komaDai_ = 240.f) noexcept;
